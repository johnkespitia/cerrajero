...
/**
 * Raised when the reservation emission cannot proceed because of fiscal
 * configuration gaps that are not the operator's fault: no active
 * CompanyFiscalProfile, no active DianResolution for the requested
 * environment, unresolvable software PIN, etc.
 *
 * The controller MUST NOT crash checkout when this is thrown. Instead it
 * should attach a structured `electronic_document_error` to the response
 * and continue committing the reservation transaction.
 */
final class ReservationEmissionUnavailableException extends ReservationEmissionException
{
